...
class ApiSauce {
  async post(url: any, data: any, headers: any, baseUrl: any) {
  ...
  async get(url: any, data: any, headers: any, baseUrl: any) {
    api.setBaseURL(baseUrl);
  ...
  async delete(url: any, data: any, headers: any, baseUrl: any) {
    api.setBaseURL(baseUrl);
  ...
  async put(url: any, data: any, headers: any, baseUrl: any) {
    api.setBaseURL(baseUrl);
  ...
  postWithProgress(url: any, data: any, headers: any) {
    if (__DEV__ && API_LOG) {
      console.log('url', url);
      console.log('headers', headers);
    }
  ...
  manipulateResponse(response: any) {
